...
properties([[$class: 'BuildDiscarderProperty',
            ...
            [$class: 'StringParameterDefinition', defaultValue: '10.10-SNAPSHOT', description: 'Product version to build', name: 'NUXEO_VERSION'],
            [$class: 'StringParameterDefinition', defaultValue: 'master', description: 'Branch to build', name: 'BRANCH'],
